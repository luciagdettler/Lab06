...
import dam.isi.frsf.utn.edu.ar.laboratorio05c2016.dao.ProyectoDBMetadata;
            ...
            public void onClick(View v) {
                ...
                if(isChecked) {
                    ...
                    if(TiempoInicial!=0){
                        ...
                        Tarea miTarea = registro.buscarTarea(idTarea);
                        miTarea.setMinutosTrabajados(miTarea.getMinutosTrabajados()+tiempoTrabajadoCalculado);
                        registro.actualizarTarea(miTarea);
                        Log.d("LAB05-MAIN","minutos trabajados: "+miTarea.getMinutosTrabajados()+tiempoTrabajadoCalculado);
